...
5. Payment by Visa/Master/Amx Card (Credit Card Processing Surcharge will be - 3.5% - 4% ) on the total amount
6. By signing this invoice, we accept above terms & Conditions.`;
